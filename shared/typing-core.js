...
(function (global) {
  ...
  const MEDALS = [
    ...
    { id: 'kpm60', name: 'KPM60とっぱ', emoji: '🚀', test: function () { return store.bestKpm >= 60; } },
    { id: 'kpm120', name: 'KPM120とっぱ', emoji: '⚡', test: function () { return store.bestKpm >= 120; } },
    { id: 'kpm200', name: 'KPM200とっぱ', emoji: '💨', test: function () { return store.bestKpm >= 200; } },
    ...
    { id: 'clearall', name: '全レベルクリア', emoji: '🏆', test: function () { return ['home', 'vowel', 'gojuon', 'words', 'special', 'phrase', 'sentence', 'text'].every(isCleared); } },
  ];
